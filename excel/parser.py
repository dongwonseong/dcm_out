...
class ExcelProcess:
    ...
    def __init__(self, type, date):
        ...
        self.name_mapping = {
            ...
            "NH투자증권": ["NH투자증권", "NH투자증권(주)", "NH투자증권 주식회사", "엔에이치투자증권(주)", "엔에이치투자증권"],
            ...
            "우리종합금융": ["우리종금", "우리종합금융(주)", "우리종합금융 주식회사", "우리종금(주)"],
            "현대차증권": ["현대차투자증권", "현대차투자증권(주)", "현대차증권(주)"],
            "디에스투자증권": ["디에스투자증권", "디에스투자증권(주)", "디에스투자증권 주식회사"],
            "신영증권": ["신영증권", "신영증권(주)", "신영증권 주식회사"],
            "엘에스증권": ["엘에스증권", "엘에스증권(주)", "엘에스증권 주식회사", "엘에스투자증권", "LS증권", "LS증권(주)", "LS증권 주식회사"],
            "아이엠증권": ["아이엠증권", "아이엠증권(주)", "아이엠증권 주식회사", "아이엠투자증권", "(주)아이엠증권"],
            "한국자산관리공사": ["한국자산관리공사(주)", "한국자산관리공사 주식회사"],
            "카카오페이증권": ["카카오페이증권(주)", "카카오페이증권", "카카오페이증권 주식회사"],
            "케이프투자증권": ["케이프투자증권", "케이프투자증권(주)", "케이프투자증권 주식회사"]
        }
